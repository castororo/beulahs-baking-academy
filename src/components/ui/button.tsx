 ...
 * - Added `cream` variant for the "learn more" cream-glow look
 * - Fixed merging of className (cn(buttonVariants(...), className))
 */
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // cream variant: transparent / subtle border + cream glow on hover (learn-more)
        cream:
          "bg-transparent text-chocolate border border-[rgba(62,45,39,0.12)] hover:text-chocolate hover:bg-cream-50 hover:shadow-[0_18px_40px_rgba(241,224,209,0.36)]",
      },
      size: {
